...
cl = ASUL.LINE()
#cl.login(token="EqZyO307bCVjQLDQFKe9.JqGb2L8XtuG6MnyFS91Woq.P/fCmfWg2+BDkRmyH8gYvTRduXhvMaAkWil0JKLIy2Y=")
cl.login(token="EqZyO307bCVjQLDQFKe9.JqGb2L8XtuG6MnyFS91Woq.P/fCmfWg2+BDkRmyH8gYvTRduXhvMaAkWil0JKLIy2Y=") 
cl.loginResult()

ki = ASUL.LINE()
ki.login(token="EqFgJFhCsh6unDbL6Ml5.n5+ondrtXVq81tevWPNQTq.8jZznjBNGkVbBTlW70fnexnIvuaTxzY/yPjb97ivYzc=") 
ki.loginResult()

ki2 = ASUL.LINE()
ki2.login(token="EqnLG0ckR7SO7MY1FvEa.DpY3HsJ1TWpjM5GLmLfXwG.ctnEsRix25QxDajc19qU+uVQu+mnNsblPgpBbpcUAp0=") 
ki2.loginResult()

ki3 = ASUL.LINE()
ki3.login(token="EqR7UGmb1UkmVon5VFAf.5//Hm3QZpSA4eXp6h24TZW.+tw2rFO9bju0A1H9pBEXdHuVHtvZAMCA1lY/ZBi8D0k=") 
ki3.loginResult()

ki4 = ASUL.LINE()
ki4.login(token="EqbUXMuhJrBWy3W2Qgue.hMCysq/c4W1Kk+FJgc3+RG.Ia/qZcVqfbTeIx9le0QukojrJJcm0cIhndDCGmOoGsM=") 
ki4.loginResult()

ki5 = ASUL.LINE()
ki5.login(token="Eqi937wlHecdAyLtZVqc.6V+uEL73w60EB9iHug3fla.6035Egod07cHZflLazXwj8NKMk1atrJtQx1FVHFhhS4=") 
ki5.loginResult()

k1 = ASUL.LINE()
#kt.login(token="EqoHomlZYX9WeYBbwdrb.LeCeuD84n792F5lfufIvoW.+m+eOlsPHSz5EwZ9UHD4RYS1g5l3SV7ZjFU8UVaHgQ4=")
k1.login(token="EqoHomlZYX9WeYBbwdrb.LeCeuD84n792F5lfufIvoW.+m+eOlsPHSz5EwZ9UHD4RYS1g5l3SV7ZjFU8UVaHgQ4=") 
k1.loginResult()

k2 = ASUL.LINE()
#k2.login(token="EqgRGVs56O8ACRWeCARb.9VKEYukdbbpHrbiZ3CKVUW.ad6/IilNzSj3/20spjiZJ68py9sBXomwx1Z4LaAiubw=")
k2.login(token="EqgRGVs56O8ACRWeCARb.9VKEYukdbbpHrbiZ3CKVUW.ad6/IilNzSj3/20spjiZJ68py9sBXomwx1Z4LaAiubw=") 
k2.loginResult()

k3 = ASUL.LINE()
#ki.login(token="EqKXwVdZTke1XoJBnfUe.VXrgK3AHnlXR88fXmo8MZG.kp+/1PC9aoCJSnTo9EIkvtPk2u0TsCg9jTDOTW2D2xc=")
k3.login(token="EqKXwVdZTke1XoJBnfUe.VXrgK3AHnlXR88fXmo8MZG.kp+/1PC9aoCJSnTo9EIkvtPk2u0TsCg9jTDOTW2D2xc=") 
k3.loginResult()

k4 = ASUL.LINE()
#k4.login(token="EqAffQIK69cqTjkY32Sb.7U8oSEk2kMekI+c+v7C5sW.8XhsHgrq4BEBoMa6ZBHmeAE1WKzlPM9FtzG3ZuXOL2o=")
k4.login(token="EqAffQIK69cqTjkY32Sb.7U8oSEk2kMekI+c+v7C5sW.8XhsHgrq4BEBoMa6ZBHmeAE1WKzlPM9FtzG3ZuXOL2o=") 
k4.loginResult()

k5 = ASUL.LINE()
#k5.login(qr="EqYMKFM2MKj5cizzNoGd.O+FkLls0pTg7IB65n3nphq.0GIIPHcUS5U2wMkYYUbVA4WUYhfNhpleMdtz6HIcDMA=")
k5.login(token="EqYMKFM2MKj5cizzNoGd.O+FkLls0pTg7IB65n3nphq.0GIIPHcUS5U2wMkYYUbVA4WUYhfNhpleMdtz6HIcDMA=") 
k5.loginResult()
...
||✒️✒ Intai       - Set Point Read
||✒️✒ Cyduk        - Reading Point
||✒️✒ Ginfo         - Info Grup
||===== F O R   A D M I N =====||
...
admsa = "u8d0801da5f314d483a98d61fb3dd7039"
admin = "u8d0801da5f314d483a98d61fb3dd7039"
...
#            cl.sendText(op.param1, "SELAMAT DATANG 😊" +  cl.getContact(op.param2).displayName + " DI ROOM" + "👉" + str(ginfo.name) + "👈")
...
#--------------------------------------------------------
              ...
              if msg.from_ in admin:
            ...
            elif msg.text in ["Point","Intai"]:
                if msg.toType == 2:
                    cl.sendText(msg.to, "Mata Mata:" +  datetime.now().strftime('\n📅%Y/%m/%d 🕛 %H:%M:%S'))
                    try:
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "==============================\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n==============================\nIn the last seen point:\n[%s]\n==============================\n Powered By:❂❂RONNA666❂❂" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
...
#----------------------ADMIN COMMAND------------------------------#
            ...
            elif msg.text in ["Mention","Tagall","Crottt ahh"]:
                group = cl.getGroup(msg.to)
                             ...
                             if not target in Bots:
                                if not target in admin:
                                  try:
                                      ...
                                      cl.sendText(msg.to,"Sukses Bosku")
                                      cl.sendText(msg.to,"TARGET DESTROYED")
              ...
              if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to," BOT BY:❂❂RONNA666❂❂")

            elif cms(msg.text,["ผู้สร้าง","Creator"]):
                msg.contentType = 13
                msg.contentMetadata = {'mid': admsa}
                cl.sendText(msg.to,"􀜁􀇔􏿿 BOT BY:❂❂RONNA666❂❂ 􀜁􀇔􏿿 ")
                cl.sendMessage(msg)
                cl.sendText(msg.to,"􀜁􀇔􏿿 http://line.me/ti/p/~anavelleo 􀜁􀇔􏿿 ")
...
#-----------------------------------------------------------
            ...
            elif msg.text in ["Responsname","Pasukan"]:
                profile = ki.getProfile()
                text = profile.displayName
                ki.sendText(msg.to, text  + " HADIR BOSS SIAP ANU!!!")
                profile = ki2.getProfile()
                text = profile.displayName
                ki2.sendText(msg.to, text + " HADIR NDAN SIAPA YANG MAU DI ANUIN???")
                profile = ki3.getProfile()
                text = profile.displayName
                ki3.sendText(msg.to, text + " TUKANG ANU HADIR BOSS!!!")
                profile = ki4.getProfile()
                text = profile.displayName
                ki4.sendText(msg.to, text + " HADIR NDAN HALIK KU AINK!!!")
                profile = ki5.getProfile()
                text = profile.displayName
                ki5.sendText(msg.to, text + " DALEM NDAN SIAP  ONO OPO YO!!!")
                profile = k1.getProfile()
                text = profile.displayName
                k1.sendText(msg.to, text  + " HADIR BOSS SIAP CROOTT NIH!!!")
                profile = k2.getProfile()
                text = profile.displayName
                k2.sendText(msg.to, text  + " SIAP BOSSKU ADA YANG BISA DI BANTING!!!")
                profile = k3.getProfile()
                text = profile.displayName
                k3.sendText(msg.to, text  + " HADIR BIAR LAMBAT ASAL SELAMAT!!!")
                profile = k4.getProfile()
                text = profile.displayName
                k4.sendText(msg.to, text  + " HADIR NDAN MACET SIKOMO LEWAT DUH!!!")
                profile = k5.getProfile()
                text = profile.displayName
                k5.sendText(msg.to, text  + " SQUAD666 KOMPLIT NDAN SIAP LAKSANAKAN PERINTAH!!!")
...
#-----------------------------------------------
            elif msg.text in ["Kuy","Sayang","666"]:
